...
class DeleteOrderUseCase @Inject constructor(private val repo: Repo) {

    fun deleteOrder(orderCode: String): Flow<ResultState<OrderDataModels>>{
        return repo.deleteOrder(orderCode)
    }
}